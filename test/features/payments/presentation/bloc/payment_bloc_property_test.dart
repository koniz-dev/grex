...
import 'payment_bloc_property_test.mocks.dart';
        ...
        test(
          ...
          () async {
            for (
              ...
              // Load payments
              paymentBloc.add(
                const PaymentsLoadRequested(groupId: 'test-group'),
              );
            ...
            for (
              ...
              if (state is PaymentsLoaded) {
                ...
                expect(
                  ...
                  isTrue,
                  reason: 'Recent timestamp after sorting iter $iteration',
                );
              }
              ...
              if (state is PaymentsLoaded) {
                ...
                for (final payment in state.payments) {
                  expect(
                    ...
                    isTrue,
                    reason: 'Valid date after real-time update iter $iteration',
                  );
                }
                ...
                expect(
                  ...
                  isTrue,
                  reason:
                      'Recent timestamp after real-time update iter $iteration',
                );
