...
void main() {
  group(
    ...
    () {
      ...
      testWidgets('should display payment direction with arrow', (
        tester,
      ) async {
        // Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should handle long names gracefully', (tester) async {
        ...
        // Act
        await tester.pumpWidget(
          createTestWidget(payment: paymentWithLongNames),
        );
      ...
      testWidgets('should handle different currencies correctly', (
        tester,
      ) async {
        // Arrange
    ...
    skip:
        'TODO(payment-widget): assertions in this file do not match what '
