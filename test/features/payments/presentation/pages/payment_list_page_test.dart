...
void main() {
  group(
    ...
    () {
      ...
      testWidgets('should display empty state when no payments', (
        tester,
      ) async {
        // Arrange
        when(mockPaymentBloc.state).thenReturn(
      ...
      testWidgets('should display list of payments when loaded', (
        tester,
      ) async {
        // Arrange
        when(mockPaymentBloc.state).thenReturn(
      ...
      testWidgets(
        'should navigate to create payment when add button is tapped',
        (
          tester,
        ) async {
          // Arrange
      ...
      testWidgets('should dispatch delete event when confirmed', (
        tester,
      ) async {
        // Arrange
        when(mockPaymentBloc.state).thenReturn(
    ...
    skip:
        'TODO(mock-migration): manual `class MockPaymentBloc extends Mock '
