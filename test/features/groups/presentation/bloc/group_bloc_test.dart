    ...
    () {
      ...
      group('GroupLeaveRequested', () {
        blocTest<GroupBloc, GroupState>(
          ...
          act: (bloc) =>
              bloc.add(const GroupLeaveRequested(groupId: 'group-1')),
          expect: () => [
      ...
      group('GroupDeleteRequested', () {
        blocTest<GroupBloc, GroupState>(
          ...
          act: (bloc) =>
              bloc.add(const GroupDeleteRequested(groupId: 'group-1')),
          expect: () => [
      ...
      group('Helper Methods', () {
        ...
        test(
          'canEditGroup should return true for administrator and editor',
          () {
