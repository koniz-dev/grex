...
void main() {
  group(
    ...
    () {
      ...
      testWidgets(
        'should show role selection dialog when changing member role',
        (
          tester,
        ) async {
          final loadedState = GroupsLoaded(
      ...
      testWidgets('should show delete group option for creators', (
        tester,
      ) async {
        final loadedState = GroupsLoaded(
          groups: [testGroup],
    ...
    skip:
        'TODO(mock-migration): test uses the manual '
