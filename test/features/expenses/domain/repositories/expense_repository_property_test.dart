...
void main() {
  group(
    'ExpenseRepository Property Tests',
    () {
            ...
            for (var i = 0; i < iterations; i++) {
              ...
              if (i % 3 == 0) {
                ...
                for (var j = 0; j < 2; j++) {
                  ...
                  final percentage =
                      Random().nextDouble() * maxPercentage + 1.0;
      ...
      group('Property 7: Equal split divides amount correctly', () {
        test(
          ...
          () async {
            ...
            for (var i = 0; i < iterations; i++) {
              ...
              participants[participants.length - 1] = participants.last
                  .copyWith(
                    shareAmount: lastShare,
                  );
              ...
              result.fold(
                ...
                (createdExpense) {
                  ...
                  final expectedShare =
                      createdExpense.amount /
                      createdExpense.participants.length;
                  for (
                    var k = 0;
        ...
        test('should handle rounding correctly in equal splits', () async {
          ...
          for (var i = 0; i < iterations; i++) {
            ...
            final participantCount =
                Random().nextInt(6) + 3; // 3-8 participants
            final amount =
      ...
      group('Property 8: Custom split validation ensures total accuracy', () {
        ...
        test('should reject custom splits with incorrect totals', () async {
          ...
          for (var i = 0; i < iterations; i++) {
            final amount = ExpenseTestGenerators.generateAmount();
            final participantCount =
                Random().nextInt(4) + 2; // 2-5 participants
        ...
        test('should validate percentage splits sum to 100%', () async {
          ...
          for (var i = 0; i < iterations; i++) {
            ...
            expect(
              ...
              isTrue,
              reason:
                  'Valid percentage split should be accepted (iteration $i)',
            );
            ...
            result.fold(
              ...
              (createdExpense) {
                ...
                final totalPercentage = createdExpense.participants
                    .fold<double>(
                      0,
                ...
                for (final participant in createdExpense.participants) {
                  ...
                  expect(
                    ...
                    reason:
                        'Share amount should match percentage (iteration $i)',
                  );
                }
              },
            );
            ...
            result.fold(
              ...
              (updated) {
                ...
                expect(
                  ...
                  reason:
                      'Should have updated participant count (iteration $i)',
                );
