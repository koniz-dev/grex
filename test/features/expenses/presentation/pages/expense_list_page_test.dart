...
void main() {
  group(
    ...
    () {
      ...
      testWidgets('should display expenses when expenses exist', (
        tester,
      ) async {
      ...
      testWidgets('should trigger refresh when pull to refresh', (
        tester,
      ) async {
        final loadedState = ExpensesLoaded(
          expenses: testExpenses,
    ...
    skip:
        'TODO(expense-page): assertions in this file (duplicate filter '
