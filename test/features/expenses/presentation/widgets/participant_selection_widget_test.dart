...
void main() {
  group(
    'ParticipantSelectionWidget Widget Tests',
    () {
      ...
      testWidgets(
        'should call onSelectionChanged when participant is selected',
        (
          tester,
        ) async {
          // Arrange
      ...
      testWidgets(
        'should deselect all participants when Select None is tapped',
        (
          tester,
        ) async {
          // Arrange
      ...
      testWidgets('should handle empty display names gracefully', (
        tester,
      ) async {
        // Arrange
    ...
    skip:
        'TODO(widget-asserts): 2 tests assert participant-selection text '
