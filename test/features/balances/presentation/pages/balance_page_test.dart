...
void main() {
  group(
    ...
    () {
      ...
      testWidgets('should display app bar with title and settlement button', (
        ...
        when(
          ...
          (_) => Stream.value(BalancesLoaded(balances: testBalances)),
        );
      ...
      testWidgets('should display empty state when no balances', (
        tester,
      ) async {
        // Arrange
        when(
      ...
      testWidgets('should display currency formatting correctly', (
        tester,
      ) async {
        // Arrange
        ...
        when(
          ...
          (_) => Stream.value(BalancesLoaded(balances: vndBalances)),
        );
      ...
      testWidgets('should handle large number of balances', (tester) async {
        ...
        when(
          ...
          (_) => Stream.value(BalancesLoaded(balances: manyBalances)),
        );
    ...
    skip:
        'TODO(mock-migration): manual `class MockBalanceBloc extends Mock '
