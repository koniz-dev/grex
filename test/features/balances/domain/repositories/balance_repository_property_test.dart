...
void main() {
  group(
    'BalanceRepository Property Tests',
    () {
                ...
                (calculatedBalances) {
                  ...
                  for (final balance in calculatedBalances) {
                    ...
                    expect(
                      ...
                      isTrue,
                      reason:
                          'Balance should have valid user ID (iteration $i)',
                    );
                    expect(
        ...
        test('should preserve balance precision', () async {
          ...
          for (var i = 0; i < iterations; i++) {
            ...
            for (var j = 0; j < precisionAmounts.length - 1; j++) {
              final amount =
                  precisionAmounts[j] * (Random().nextBool() ? 1 : -1);
              totalBalance += amount;
        ...
        test(
          ...
          () async {
            ...
            for (var i = 0; i < iterations; i++) {
              ...
              result1.fold(
                (failure) =>
                    fail('First calculation should not fail: $failure'),
                (balances1) {
                  result2.fold(
                    (failure) =>
      ...
      group('Property 20: Settlement plan minimizes transactions', () {
        ...
        test('should handle complex multi-person '
          ...
          for (var i = 0; i < iterations; i++) {
            ...
            result.fold(
              (failure) =>
                  fail('Should not fail for complex scenario: $failure'),
              (settlementPlan) {
                ...
                expect(
                  ...
                  reason:
                      'Total settlements should be reasonable (iteration $i)',
                );
              },
            );
          }
