  ...
  group(
    ...
    () {
      ...
      group('Table Subscriptions', () {
        ...
        test(
          'should unsubscribe existing channel when resubscribing',
          () async {
            // Arrange
            await realTimeService.start();
      ...
      group('Change Synchronization', () {
        test('should sync INSERT operation', () async {
          ...
          when(
            mockSupabaseClient.from('expenses'),
    ...
    skip:
        'TODO(supabase): SupabaseRealTimeService depends on a real '
        'Supabase client; tests fail at construction because no Supabase '
        'instance is initialized in the test binding. Re-enable after wiring '
        'a fake Supabase client (or running these as integration tests).',
  );
}
