...
/// Friendly error state for the balance page.
class BalanceListErrorWidget extends StatelessWidget {
  /// Creates a [BalanceListErrorWidget].
  const BalanceListErrorWidget({required this.onRetry, super.key});
