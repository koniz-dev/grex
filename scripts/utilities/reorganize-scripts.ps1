...
"@
    ...
    Write-Log "Created build/README.md" "INFO" "Green"
...
- name: Generate changelog
  run: ./scripts/maintenance/generate_changelog.sh `${{ github.event.release.tag_name }}
...
try {
    ...
    if ($structureValid) {
        ...
        Write-Log "  scripts/build/ - Build and deployment scripts" "INFO" "Cyan"
        Write-Log "  scripts/development/ - Development workflow scripts" "INFO" "Cyan"
        Write-Log "  scripts/testing/ - Testing and quality scripts" "INFO" "Cyan"
        Write-Log "  scripts/maintenance/ - Project maintenance scripts" "INFO" "Cyan"
        Write-Log "  scripts/database/ - Database management scripts" "INFO" "Cyan"
        Write-Log "  scripts/utilities/ - General utility scripts" "INFO" "Cyan"
