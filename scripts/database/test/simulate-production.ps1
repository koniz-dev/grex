...
1. **Run readiness test:**
   ```powershell
   .\scripts\database\test\production-readiness.ps1
   ```

2. **Run actual deployment:**
   ```powershell
   .\scripts\database\deploy\production.ps1 -DryRun
   .\scripts\database\deploy\production.ps1
   ```
...
try {
    ...
    Write-Host "1. Run: .\scripts\database\test\production-readiness.ps1"
    Write-Host "2. Run: .\scripts\database\deploy\production.ps1 -DryRun"
    Write-Host "3. Run: .\scripts\database\deploy\production.ps1"
    Write-Host ""
