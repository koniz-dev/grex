...
$expectedStructure = @{
    ...
    "scripts/database/migrations/manage-migrations.ps1" = "Migration management script"
    "scripts/database/backup/backup-database.ps1" = "Database backup script"
    "scripts/database/utilities/reorganize-docs.ps1" = "Documentation reorganization script"
    "scripts/database/utilities/validate-structure.ps1" = "This validation script"
}
...
function Test-FileContent {
    ...
    if (Test-Path "scripts/database/migrations/manage-migrations.ps1") {
        $content = Get-Content "scripts/database/migrations/manage-migrations.ps1" -Raw
...
function New-StructureReport {
    ...
    $scriptFiles = (Get-ChildItem -Path "scripts/database" -Recurse -File).Count
