...
## Alert Channels
- **Log Files:** scripts/linux/database/monitoring/alerts/health.log
...
```bash
# Run health check
./scripts/linux/database/monitoring/check-health.sh

# Generate performance dashboard
./scripts/linux/database/monitoring/generate-dashboard.sh

# Run all monitoring tasks
./scripts/linux/database/monitoring/run-tasks.sh
```
