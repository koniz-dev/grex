...
# Usage: ./scripts/linux/testing/test_coverage.sh [options]
# Options:
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    *)
      ...
      echo "Usage: ./scripts/linux/testing/test_coverage.sh [--html] [--open] [--min=<percent>] [--exclude=<path>] [--analyze] [--no-test]"
      exit 1
      ;;
  esac
done
