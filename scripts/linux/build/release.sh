...
# Usage: ./scripts/linux/build/release.sh [major|minor|patch]
...
./scripts/linux/development/bump_version.sh $BUMP_TYPE
...
./scripts/linux/maintenance/generate_changelog.sh $NEW_VERSION
